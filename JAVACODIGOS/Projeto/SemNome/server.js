...
app.use(
    helmet.contentSecurityPolicy({
        directives: {
            defaultSrc: ["'self'"],
            scriptSrc: ["'self'", "https://cdn.jsdelivr.net", "https://ajax.googleapis.com", "https://code.jquery.com"],
            styleSrc: ["'self'", "https://cdn.jsdelivr.net", "https://maxcdn.bootstrapcdn.com"],
